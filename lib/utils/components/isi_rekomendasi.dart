...
class IsiRekomendasi extends StatelessWidget {
  final int idBerita;
  const IsiRekomendasi({Key? key, required this.idBerita}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var berita =
        Get.find<BeritaRekomendasiController>().beritaRekomendasiList[idBerita];
    ...
    String dateString = berita.tglDibuat!;
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: ReusableText(
                        text: beritaRekomendasiController
                            .formatTimeElapsed(dateRekomendasi),
                        style: appstyle(
                          14,
                          Color(kLight.value),
                          FontWeight.w400,
